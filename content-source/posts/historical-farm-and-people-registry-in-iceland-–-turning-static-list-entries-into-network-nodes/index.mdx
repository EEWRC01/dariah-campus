...
shortTitle: Historical Farm and People Registry in Iceland
lang: en
date: 2024-05-20T11:50:55.931Z
version: 1.0.0
authors:
  - björnsson-pétur-húni
editors:
  - garnett-vicky
contributors: []
tags:
...
categories:
  - dariah
abstract: >
  This presentation outlines the aim and scope of the Historical Farm and People
  Registry project, explains the development process and problems encountered on
  the way, and demonstrates a use case for the 'final' product.
...
<VideoCard provider="youtube" id="y7wme88QTb8" title="Historical Farm and People Registry in Iceland – Turning static list entries into network nodes" subtitle="Click here to view" image="images/phb-thumbnail.png" />
