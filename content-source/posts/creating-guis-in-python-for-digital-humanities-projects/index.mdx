...
featuredImage: images/creating-guis-in-python-for-digital-humanities-projects-original.png
abstract: In this lesson, you will use Qt Designer and Python to design and
