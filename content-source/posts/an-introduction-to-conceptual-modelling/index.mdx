...
<ExternalResource title="Interested in learning more?" subtitle="Check out An Introduction to Conceptual Modelling on #dariahTeach" url="https://teach.dariah.eu/course/view.php?id=31 " />
