...
![](https://lh4.googleusercontent.com/XeiCLNchIopJPGq0VNE5ZHOxBBxlpm9Ze8Pw4IyFfQMKQRp2Urw5yAdGwsz3IfIpIaZXIsbnPGFv4V7KBw39IVwIwZ2T476BEbgA2XYtRMUCBRNH\_6jGEFKSvB9PSuGsyBeCSL-zsfsDgDVEynwo3M0 "Figure 1: concordances for the query ‘word’ in the ukWac corpus in the Kontext CQS.")
...
Other features offered by corpus tools involve some type of statistical calculation, for example word lists, collocations, synonyms and so forth (see Section 4 in the course [Introduction to Corpus-Based Lexicographic Practice](/id/50Ga8xo5uDgdrz2eIIifW)  for more and Atkins and Rundell 2008:108). Among the more advanced features and highly valuable to lexicographers, are detailed collocation presentation (lexical profiling), good dictionary example identification tool, and tickbox lexicography.
...
![](https://lh6.googleusercontent.com/6fm-A3XJyt3KYPU4vzkgBWCdy6nZc\_98sNSW7fNcT5fdpVGrF9\_pHEOwjfOZpFURUcy7g6OiOCcq4G2MwEBRP0GHZ782YuhTqf9Z3VKmPMHdOcmSVDiGAUDyb3Kp1Es5mxsEsQS1TPzeGyLaqKfQH64 "Figure 2. Part of the Word Sketch for the noun apple.")
...
![](https://lh5.googleusercontent.com/v1FxLIkPuQWbc6v4Sb_ImJ5\_TSsNoSMLYtLJx0Q4VfXDVM_r18Z9aWGYyaHgGLqvw38NZxXIFJOWpzcUibIAfjJTerDNVVXg4ZL0-bOTRjrgqjA7dl0M4isQeKKo-Ik_bpJnT2uM6y_YcKHo8dAU3Xc "Figure 6. TBL in Sketch Engine")
...
A separate module of the ELEXIS Curriculum gives an overview of the [CLARIN Tools and Resources for Lexicographic Work](/id/UnwYPq70Dewbn7XDEjsMM).
...
Herman, O. et al. (2019). ‘Word Sense Induction Using Word Sketches’, in C. Martín-Vide, M. Purver, and S. Pollak (eds) Statistical Language and Speech Processing. Cham: Springer International Publishing (Lecture Notes in Computer Science), 83–91. Available at: [https://doi.org/10.1007/978-3-030-31372-2\_7](https://doi.org/10.1007/978-3-030-31372-2\_7).
...
Kallas, J., Koeva, S., Kosem, I., Langemets, M. and Tiberius, C. (2019a). [ELEXIS deliverable 1.1 Lexicographic Practices in Europe: A Survey of User Needs.](https://elex.is/wp-content/uploads/2020/06/Revised-ELEXIS_D1.1\_Lexicographic_Practices_in_Europe_A_Survey_of_User_Needs.pdf).
...
Kosem, I., et al. "[Language Monitor: tracking the use of words in contemporary Slovene.](https://elex.link/elex2021/wp-content/uploads/2021/08/eLex\_2021\_33\_pp514-528.pdf)" Electronic lexicography in the 21st century (eLex 2021) Post-editing lexicography: 93.
