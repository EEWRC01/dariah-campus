...
abstract: The EHRI (European Holocaust Research Infrastructure) Search API
  ...
  URLs. This short tutorial shows learners how use a command line tool (CuRL) to fetch structured data and transform it into CSV (comma separated values) format for import
