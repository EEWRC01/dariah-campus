		...
		<Section>
			...
			<ul className="grid gap-8 py-6 md:grid-cols-3" role="list">
				{links.map((link, index) => {
					return (
						<li key={index}>
							<article className="relative flex h-full flex-col items-center space-y-2 rounded-xl border border-neutral-100 p-12 text-center shadow-md transition hover:shadow-lg focus:outline-none focus-visible:ring focus-visible:ring-primary-600">
								<img alt="" className="size-20 text-primary-600" src={link.image} />
								<h3 className="text-xl font-semibold">
									<Link className="after:absolute after:inset-0" href={link.href}>
										{link.title}
									</Link>
								</h3>
