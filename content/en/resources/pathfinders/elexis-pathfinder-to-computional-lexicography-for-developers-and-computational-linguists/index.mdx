...
summary:
  content: This learning resource provides software developers and computational
    linguists with an overview of the typical computational processing tasks and
    software tools in the lexicographic workflow. The resource introduces the
    most widely used custom developed tools for corpus-based lexicography as
...
In the courses, [Lexonomy: Mastering the ELEXIS Dictionary Writing System](/resources/hosted/lexonomy-mastering-the-elexis-dictionary-writing-system) and [LEX2:  Mastering ELEXIS Corpus Tools for Lexicographic Purposes](/resources/hosted/lex2-mastering-elexis-corpus-tools-for-lexicographic-purposes), you can learn how to use the DWS Lexonomy and the CQS Sketch Engine. In this pathfinder, we take a broader perspective. We describe in a nutshell what a DWS and a CQS is, what the main characteristics are and what kinds of systems there are and where you can find them.
...
![](/assets/content/assets/en/resources/pathfinders/elexis-pathfinder-to-computional-lexicography-for-developers-and-computational-linguists/xei-cl-nch-iop-jp-gq0-vne-5-zh-ox-b-bxlpm9-ze8-pw4-iy-ff-qmkq-rp2-urw5y-ad-gwsz3-if-ip-ia-zxisbn-pg-fv4-v7-k-bw39-i-vw-iw-z2-t476-b-ebg-a2-x-yt-rmucbrnh-6j-gefk-sv-b9-p-su-gsy-be-csl-zsfs-dg-dv-eynwo3-m0.png "Figure 1: concordances for the query 'word' in the ukWac corpus in the Kontext CQS.")
...
Other features offered by corpus tools involve some type of statistical calculation, for example word lists, collocations, synonyms and so forth (see Section 4 in the course [Introduction to Corpus-Based Lexicographic Practice](/resources/hosted/introduction-to-corpus-based-lexicographic-practice)  for more and Atkins and Rundell 2008:108). Among the more advanced features and highly valuable to lexicographers, are detailed collocation presentation (lexical profiling), good dictionary example identification tool, and tickbox lexicography.
...
![](/assets/content/assets/en/resources/pathfinders/elexis-pathfinder-to-computional-lexicography-for-developers-and-computational-linguists/6fm-a3-x-jyt3-kypu-4vzkg-bw-cdy6n-zc-98s-nsw-7f-nc-t5fdp-v-gr-f9-p-he-owjf-o-zp-fur-ucy7g6-oi-o-ccq4-g2-mw-ebrp-0-ghz-782-yuh-tqf9-z3-v-km-pm-hd-ocm-sv-di-gau-dyb3-kp1-es5mxs-es-qs-1-t-pze-gy-laq-kf-qh-64.png "Figure 2. Part of the Word Sketch for the noun apple.")
...
![](/assets/content/assets/en/resources/pathfinders/elexis-pathfinder-to-computional-lexicography-for-developers-and-computational-linguists/pjlz-y1e5snacu-fp-23p-vm-5sj-8ohljz-i-ut-b9-j8l-ysd-8ew-yztjg-wyd5-g-ph3-gr-ez-mb-y3-qa-9hn-i93uqm-cd41t-m6-su-i7-kv-76r-lc6-oa-sd-1-yl-yc-xhd-r-ylk-mak-4r6na2uh03-nb-o-lf-wg-of-u8n-ao-2-d-ef4-9c.png "Figure 3. Concordances for apple (sentence view) in the British National Corpus before GDEX sorting")

![](/assets/content/assets/en/resources/pathfinders/elexis-pathfinder-to-computional-lexicography-for-developers-and-computational-linguists/gr-pc-p-zwl-ao-4-iw-7oo5-yk-q6wgal-yn8-gihwtki-jb-ljns-u-pds8v-j5fiu-o-zx9-s-nb7-d3-a-qf5jp6-v3-cn3n1ki-k3-ql2-ep-sc-jx0-q6p2-td-i-vt7z5-sv-f5nwz-er8jxe-n-eiuf3-q-ckg-e0-z-mw-lr-i97-y-pobqbav1y-jik.png "Figure 4. Concordances for apple (sentence view) in the British National Corpus after GDEX sorting")
...
![](/assets/content/assets/en/resources/pathfinders/elexis-pathfinder-to-computional-lexicography-for-developers-and-computational-linguists/v1-fx-l-ik-pu-q-wbc6v4-sb-im-j5-tss-no-sml-yt-l-jx0-q4-vf-xdvm-r18-z9a-wg-yya-hg-g-lqvw38-n-zx-xifjo-wpzc-uib-i-afj-j-ter-dnvv-xg4-zl-0-b-ot-rjrgqj-a7dl0-m4is-qe-k-ko-ik-bp-jn-t2u-m6y-yc-k-ho8d-au-3-xc.png "Figure 6. TBL in Sketch Engine")
...
A separate module of the ELEXIS Curriculum gives an overview of the [CLARIN Tools and Resources for Lexicographic Work](/resources/hosted/clarin-tools-and-resources-for-lexicographic-work).

#### European Language Grid

The [European Language Grid](https://live.european-language-grid.eu/) provides access to Language Technology resources from all over Europe. ELG contains tools and services, language resources and information on European LT companies and research organisations as well as their projects.

### Other websites with overviews of corpus resources

* [https://corpus.tools/](https://corpus.tools/) A joint portal of the ​Masaryk University's NLP Centre and ​Lexical Computing dedicated to a number of software tools for corpus processing.
* [https://corpus-analysis.com/](https://corpus-analysis.com/) A comprehensive list of tools used in corpus compilation and analysis which is kept up to date by users.
* [Essex university W3 Corpora project](https://www1.essex.ac.uk/linguistics/external/clmt/w3c/corpus_ling/content/software.html)
...
Abel, A. (2012). Dictionary writing systems and beyond. In: Granger, Sylviane / Paquot, Magali (eds.): Electronic Lexicography. Oxford: Oxford University Press. [https://www.researchgate.net/publication/259453133\_Dictionary\_Writing\_Systems\_and\_Beyond](https://www.researchgate.net/publication/259453133_Dictionary_Writing_Systems_and_Beyond)
...
Herman, O. et al. (2019). 'Word Sense Induction Using Word Sketches', in C. Martín-Vide, M. Purver, and S. Pollak (eds) Statistical Language and Speech Processing. Cham: Springer International Publishing (Lecture Notes in Computer Science), 83–91. Available at: [https://doi.org/10.1007/978-3-030-31372-2\_7](https://doi.org/10.1007/978-3-030-31372-2_7).
