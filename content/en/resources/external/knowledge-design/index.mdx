...
summary:
  ...
  content: In this lecture from the Austrian Centre for Digital Humanities and
    Cultural Heritage (ACDH-CH), Jeffrey Schnapp outlines the main questions
    which Knowledge Design is concerned with. Schnapp provides an overview of
    the current situation of boundaries between libraries, museums, archives,
    and the classroom becoming growing porous. Additionally, he explores the
    role of knowledge in Digital Humanities, and which methods and tools are
    ideal for efficient knowledge extraction.
content-type: video
remote:
...
<VideoCard provider="youtube" id="FttED2UKemY" title="ACDH-CH Lecture 2.1 – Jeffrey Schnapp – Knowledge Design" image="/assets/content/assets/en/resources/external/knowledge-design/acdh-logo-png" subtitle="Click here to view" />
