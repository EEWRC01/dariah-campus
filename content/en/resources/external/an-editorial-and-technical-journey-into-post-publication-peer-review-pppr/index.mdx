...
<VideoCard title="Click to view" subtitle="An Editorial and Technical Journey into Post-Publication Peer Review (PPPR)" id="Xd7Pyp8srno" image="images/PPPR-title-slide.png" />
