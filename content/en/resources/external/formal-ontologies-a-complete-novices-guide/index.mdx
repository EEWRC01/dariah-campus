...
summary:
  content: This module is specifically aimed at those who are not yet familiar
    with ontologies as a means of research data management, and will take you
    through some of the main features of ontologies, and the reasons for using
    them.
...
<ExternalResource title="Interested in learning more?" subtitle="Check out Formal Ontologies: A Complete Novice's Guide on PARTHENOS" url="http://training.parthenos-project.eu/sample-page/formal-ontologies-a-complete-novices-guide/" />
