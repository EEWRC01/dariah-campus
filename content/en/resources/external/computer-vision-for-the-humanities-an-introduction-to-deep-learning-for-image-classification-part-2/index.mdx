...
locale: en
publication-date: 2024-02-06T12:04:57.460Z
version: 1.0.0
authors:
  - van-strien-daniel
  - beelen-kaspar
...
featured-image: /assets/content/assets/en/resources/external/computer-vision-for-the-humanities-an-introduction-to-deep-learning-for-image-classification-part-2/featured-image.png
license: cc-by-4.0
table-of-contents: false
summary:
  content: This is the second of a two-part lesson introducing deep learning based
    computer vision methods for humanities research. This lesson digs deeper
    ...
    importance of choosing an appropriate metric for your model. It presents
    some methods for evaluating the performance of a model.
content-type: training-module
remote:
  publication-date: 2022-08-17T00:00:00.000Z
