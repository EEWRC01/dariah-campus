...
summary:
  title: Computational Museology
  content: This keynote lecture delivered at the DARIAH Annual Event 2021 by Sarah
    Kenderdine explores how computation has become 'experiential, spatial and
    materialized; embedded and embodied'.
...
<VideoCard provider="youtube" id="4I_ACsfJlDU" title="Computational Museology: Experimental Interfaces to Cultural Big Data" image="/assets/content/assets/en/resources/hosted/computational-museology-experimental-interfaces-to-cultural-big-data/sarah-kenderdine-image-png" subtitle="Click here to view" />
