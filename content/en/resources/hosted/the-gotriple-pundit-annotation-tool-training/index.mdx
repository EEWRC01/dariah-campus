...
summary:
  ...
  content: This training webinar is dedicated to the GoTriple Pundit Annotation
    Tool and presents the purpose, functionalities, perspectives and a roadmap
    of Pundit, including the plan to enlist it as a EOSC service. A researcher
...
<VideoCard provider="youtube" id="DmKT4wktPG4" title="The GoTriple Pundit Annotation Tool" image="/assets/content/assets/en/resources/hosted/the-gotriple-pundit-annotation-tool-training/pundit-triple-png" subtitle="Click here to view" />
