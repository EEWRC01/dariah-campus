...
<VideoCard provider="youtube" id="b8NaN28eFxY" title="Click to view" image="/assets/content/assets/en/resources/hosted/flipped-classrooms/flipped-classrooms-title-slide-jpeg" subtitle="Flipped Classrooms" />
