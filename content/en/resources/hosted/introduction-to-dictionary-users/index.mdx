...
summary:
  content: The goal of this course is to introduce students to the important role
...
[Introduction to Dictionaries](/resources/hosted/introduction-to-dictionaries).
...
As we already learned in the [Introduction to Dictionaries](/resources/hosted/introduction-to-dictionaries#audience),
...
then have an effect on dictionary [macrostructure](/resources/hosted/introduction-to-dictionaries#macrostructure) and
[microstructure](/resources/hosted/introduction-to-dictionaries##microstructure), for example on the amount of
...
There are many [criteria](/resources/hosted/introduction-to-dictionaries#dictionary-typologies) that can be used to
...
![](/assets/content/assets/en/resources/hosted/introduction-to-dictionary-users/elexis-figure1-eng.png "Figure 1: Arhar Holdt, Spela, Kosem, Iztok, Gantar, Polona. 2016. Dictionary user typology: The Slovenian Case. p.182. Taken from: https://euralex.org/wp-content/themes/euralex/proceedings/Euralex%202016/euralex_2016_015_p179.pdf. Last Access: 13 May 2022.")
...
![](/assets/content/assets/en/resources/hosted/introduction-to-dictionary-users/overall-dissimilarity-sl-eu.png "Figure 2: Overall dissimilarity Slowenian and EU dictionary users")
...
![](/assets/content/assets/en/resources/hosted/introduction-to-dictionary-users/esd-plot-2022-05-12-europe.png "Figure 3")

![](/assets/content/assets/en/resources/hosted/introduction-to-dictionary-users/esd-plot-2022-05-12-north-macedonia.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-dictionary-users/table-1-overview.png "Table 1")
...
This course and the [Introduction to Dictionaries](/resources/hosted/introduction-to-dictionaries) serve as a good point
...
check out our [Introduction to Corpus-Based Lexicographic Practice](/resources/hosted/introduction-to-corpus-based-lexicographic-practice).
...
[Capturing, Modeling and Transforming Lexical Data: An Introduction](/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction).
...
case". In: MARGALITADZE, Tinatin (ed.), MELADZE, George (ed.). *Lexicography and linguistic
diversity: Proceedings of the XVII EURALEX International Congress*, 6-10 September, 2016. Ivane
Javakhishvili Tbilisi State University. p.179-187.

Giacomini, Laura. 2018. "Dictionaries for Translation". In: Pedro A. Fuertes-Olivera (ed.) *The
