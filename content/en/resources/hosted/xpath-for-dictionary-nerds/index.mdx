...
If you're new to XML, make sure you review the basics by (re)visiting the ELEXIS course [Capturing, Modeling and Transforming Lexical Data: An Introduction](/id/3yV0rXgfTgBFa3jXHm1HX) and, in partiuclar, sections on [XML building blocks and basic rules](/id/3yV0rXgfTgBFa3jXHm1HX#xml-building-blocks-and-basic-rules)
