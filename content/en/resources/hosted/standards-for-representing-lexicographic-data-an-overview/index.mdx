...
summary:
  content: This course focuses on the importance of standards to facilitate the
    cooperation among lexicographers in a multilingual and multicultural
    context.
...
Standards provide common principles and methods to build, organise and structure lexicographic data in order to share them and facilitate cooperation between lexicographers independently of the language and the culture.

There are different kinds of standards according to the aims such as methods (ISO), digital representation of resources (TEI) or exchange formats (W3C).
...
All TEI documents must include a metadata section, named *TEI header*, and share a set of common annotation features defined as the core module in the standard. This set includes structural elements such as paragraphs, lists or bibliographical references.
...
* blocks or 'compositional element used to factorise elements that are shared as refiners by many instances of a specific element' (*ibidem*) (e.g., a punctuation such as comma or semicolon to separate meanings, square brackets for contexts);
* groups or 'compositional element used to aggregate several independent elements' (*ibidem*) (e.g., a sense is described by a group of elements such as definition, usage labels).
...
OntoLex-Lemon has become widely known for the representation of lexical data on the semantic web, including Princeton WordNet and FrameNet, and has gradually acquired the status of a *de facto* standard[^14]. Concerning the conversion of lexicographic resources into linked open data (LOD)[^15], this model is the preferred choice of many researchers (Klimek & Brümmer, 2015; Declerck et al., 2019; Abromeit et al., 2016; Bosque-Gil et al., 2016; McCrae et al., 2019).

[^14]: [https://en.wikipedia.org/wiki/Knowledge\_graph;https://www.w3.org/community/ontolex/](https://en.wikipedia.org/wiki/Knowledge_graph;https://www.w3.org/community/ontolex/)
...
### 1. The core terminology for lexicographic work

The purpose of this document is to present the main concepts that are necessary to work on monolingual dictionaries. The main body of a dictionary has three structures: *macrostructure*, *microstructure*, and *mediostructure* (Figure 1).

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/dic-structure.png "Figure 1: Model of a Dictionary Structure (Salgado, 2021)")

We are going now to define the core vocabulary that helps the lexicographer to structure a lexicographic article in a dictionary. The definitions we present below correspond to the basic knowledge one must have to perform lexicographic work.

The concepts are defined using three different approaches in order to serve several purposes. The graphical representation allows identifying the main concepts and their relationships when the formal language (context-free language) guarantees consistency. Finally, the definition in natural language provides a human-readable format.

#### 1.1 dictionary

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-2.png "Figure 2")

#### 1.2 lexicographic article

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/lexicographic-article.png "Figure 3")

#### 1.3 dictionary structure

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/1.3.png "Figure 4")

#### 1.4 macrostructure

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-5.png "Figure 5")

#### 1.5 microstructure

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-6.png "Figure 6")

#### 1.6 mediostructure

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-7.png "Figure 7")

#### 1.7 lexicon

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-8.png "Figure 8")

#### 1.8 lexical unit

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/lexical-unit.png "Figure 9")

#### 1.9 lexicographic component

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-10.png "Figure 10")

#### 1.10 headword

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/1.9.png "Figure 11")

#### 1.11 sense

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-12.png "Figure 12")

#### 1.12 part of speech

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-13.png "Figure 13")

#### 1.13 canonical form

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-14.png "Figure 14")

#### 1.14 lemma

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-15.png "Figure 15")

#### 1.15 sense component

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-16.png "Figure 16")

#### 1.16 lexicographic definition

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/lexicographic-definition.png "Figure 17")

#### 1.17 label

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-18.png "Figure 17")

#### 1.18 example

<Embed src="/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/example.png" alt="Figure 18" />

#### 1.19 note

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-19.png "Figure 19")

### 2. Lexicographic article

According to the core vocabulary we have defined, we propose a minimal microstructure of a monolingual lexicographic article.

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/minimal-structure.png "Figure 20: XML representation of minimal microstructure of a monolingual lexicographic article")
...
The lexicographic articles used below, despite having a more complex structure and consequently presenting more lexicographic components, serve to illustrate the proposed minimal structure.

#### 2.1 English lexicographic article: fly

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/fly.drawio.png "English lexicographic article. Retrieved from: Oxford English Dictionary, https://www.oed.com (07/01/2022)")

#### 2.2 French lexicographic article: mouche

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/mouche.drawio.png "French lexicographic article. Retrieved from: Le Robert, https://dictionnaire.lerobert.com/definition/mouche (07/01/2022)")

#### 2.3 Portuguese lexicographic article: mosca

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/mosca.drawio.png "Portuguese lexicographic article. Retrieved from:  Dicionário da Língua Portuguesa Contemporânea, Academia das Ciências de Lisboa (2001)")

### 3. Modelling and encoding lexicographic article

#### 3.1 OntoLex Lemon

OntoLex-Lemon was developed by the W3C Ontology-Lexica Community Group based on previous models. This has become widely known for representation of lexical data on the semantic web and has gradually acquired the status of a de facto standard according to the principles of linked data.
...
![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/fly-ontolex.png "Representation following Turtle code")

#### 3.2 TEI LEx-0

TEI Lex-0 is a stricter subset of TEI that aims for a stricter TEI representation of heterogeneous TEI-based lexical resources. Its goal is to establish a baseline encoding and a target format to facilitate the interoperability of heterogeneously encoded lexical resources. We present an example, which purpose is to give a representation of an encoded lexicographic article according to the core vocabulary we have defined.

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/fly-tei.png "TEI Lex-0 encoded lexicographic article")

#### 3.3 LMF

The Lexical Markup Framework (LMF) is a de jure multi‐part standard within ISO 24613 (ISO 24613-1, 2019; ISO 24613-2, 2020; ISO 24613-3, 2021; ISO 24613-4, 2021; ISO 24613-5, 2021) that provides a common standardised structure to have a flexible specification platform for lexical data, mainly for NLP applications with an extension to represent lexical resources and machine-readable dictionaries (MRD). We present an example, which purpose is to give a representation of a structured lexicographic article according to the core vocabulary we have defined.

![](/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/fly-lmf.png "LMF encoded lexicographic article")

### 4. LexModel – Core Terminology for Lexicography

LexModel defines the core terminology for organising, structuring and representing monolingual dictionaries and has been elaborated for teaching, training, and learning purposes in the context of ELEXIS curriculum design.

<Embed src="/assets/content/assets/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/lexml-18-07-22.png" alt="LexModel" />

### References

Abromeit, F., Chiarcos, C., Fäth, C., & Ionov, M. (2016). Linking the tower of Babel: modelling a massive set of etymological dictionaries as RDF. In J. McCrae et al. (Eds.), *Proceedings of the 5th Workshop on Linked Data in Linguistics (LDL-2016): Managing, Building and Using Linked Language Resources*, Portoroz, Slovenia (pp. 11–19). Retrieved from [http://www.lrec-conf.org/proceedings/lrec2016/workshops/LREC2016Workshop-LDL2016\_Proceedings.pdf](http://www.lrec-conf.org/proceedings/lrec2016/workshops/LREC2016Workshop-LDL2016_Proceedings.pdf).
...
Bohbot, H., Frontini, F., Luxardo, G., Khemakhem, M., & Romary, L. (2018). Presenting the Nénufar Project: A diachronic digital edition of the Petit Larousse Illustré. In *GLOBALEX 2018 – Globalex workshop* at LREC2018, May 2018, Miyazaki, Japan (pp. 1–6). Retrieved from [https://hal.archives-ouvertes.fr/hal-01728328](https://hal.archives-ouvertes.fr/hal-01728328).

Bosque-Gil, J., Gracia, J., & Gómez-Pérez, A. (2016). Linked data in lexicography. *Kernerman Dictionary News*, *24*:19–24. Retrieved from [https://lexicala.com/wp-content/uploads/2021/03/kdn24\_2016.pdf](https://lexicala.com/wp-content/uploads/2021/03/kdn24_2016.pdf).

Bowers, J., Herold, A., Romary, L., Tasovac. T. (2021). TEI Lex-0 Etym – Towards terse recommendations for the encoding of etymological information. Preprint. Retrieved from [https://halinria.fr/hal-03108781](https://halinria.fr/hal-03108781).
...
Cimiano, P., McCrae, J. P., & Buitelaar, P. (2016). *Lexicon Model for Ontologies: Community Report*. W3C Community Group Final Report. Retrieved from [https://www.w3.org/2016/05/ontolex/](https://www.w3.org/2016/05/ontolex/).
...
Klimek, B. & Brümmer, M. (2015). Enhancing lexicography with semantic language databases. *Kernerman Dictionary News*, 23, 5–10. Retrieved from [https://www.kdictionaries.com/kdn/kdn23\_2015.pdf](https://www.kdictionaries.com/kdn/kdn23_2015.pdf).
...
Romary, L., & Tasovac, T. (2018). TEI Lex-0: A target format for TEI-Encoded dictionaries and lexical resources. In *Proceedings of the 8th Conference of Japanese Association for Digital Humanities* (pp. 274–275). Retrieved from [https://tei2018.dhii.asia/AbstractsBook\_TEI\_0907.pdf](https://tei2018.dhii.asia/AbstractsBook_TEI_0907.pdf).
