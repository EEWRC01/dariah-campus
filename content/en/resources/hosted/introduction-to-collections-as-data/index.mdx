...
summary:
  title: Introduction to Collections as Data
  content: The goal of this course is to introduce the Collections as Data
    principles in the cultural heritage sector to make available a digital
    collection suitable for computational use. Students will have a fundamental
    understanding of the complexities of Collections as Data as well as an
    appreciation of the diversity of the content provided by cultural heritage
    institutions. This course will be useful for small and medium-sized
    institutions willing to make available their digital collections suitable
    for computational use.
content-type: training-module
---
The goal of this course is to introduce the Collections as Data principles in the cultural heritage sector and to analyse the different aspects to consider when making available a digital collection suitable for computational use. In order to do so, the course will cover a selection of relevant facets to publish collections as data such as providing a licence, terms of use, documentation and examples of use, or using a platform to make available the collection. At the end of this course, students will have a fundamental understanding of the complexities of Collections as Data as well as an appreciation of the diversity of the content provided by cultural heritage institutions. This course will be useful for anyone wishing to improve their knowledge about Collections as Data, especially small and medium-sized cultural heritage institutions willing to make available their digital collections suitable for computational use. Additionally, it will provide Collections as Data examples provided by relevant institutions.

## Learning outcomes

Upon completion of this course, participants will be able to:

* understand the relevance of Collections as Data in the context of the cultural heritage sector
* appreciate the complexity of Collections as Data
* analyse the structure of a digital collection suitable for computational use
* understand the steps involved when publishing collections as data
...
<Callout kind title="Exercise 2">
  If you are curious about Collections as Data, then *[50 Things](https://collectionsasdata.github.io/fiftythings/)* could be a good place to start! It provides a list of actions that you can use to publish collections as data. You can start by identifying two or three actions (e.g., "17. Share sample projects with community partners to give them an idea of how their collections can be used") in the list that can be easily applied to your institution.
</Callout>
...
In this sense, workflows can be useful to split the task in a set of individual steps, enabling adopters to identify and focus on one or more of them. A [workflow](https://marketplace.sshopencloud.eu/workflow/I3JvP6) has been developed in the context of the [common European data space for cultural heritage](https://pro.europeana.eu/page/common-european-data-space-for-cultural-heritage). Building on the [Checklist to Publish Collections as Data in GLAM Institutions](https://marketplace.sshopencloud.eu/publication/uviY8r) and tested and refined with the support of the International GLAM Labs Community, the workflow provides a set of ten steps focused on the publication of collections as data in GLAMs. Each step is described in terms of how it can be applied and why it is relevant, including a selection of relevant examples. This intends to provide guidelines and best practices that can be useful for institutions taking their first steps.

![Steps provided by the workflow to publish collections as data](/assets/content/assets/en/resources/hosted/introduction-to-collections-as-data/workflow.png "Steps provided by the workflow to publish collections as data")
...
* Candela, G., Chambers, S. and Irollo, A. (2024), "A workflow to publish Collections as Data: the case of Cultural Heritage data spaces". [https://marketplace.sshopencloud.eu/workflow/I3JvP6](https://marketplace.sshopencloud.eu/workflow/I3JvP6)
