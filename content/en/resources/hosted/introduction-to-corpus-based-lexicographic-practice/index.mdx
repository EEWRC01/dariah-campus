...
summary:
  content: This course will explore the notion of lexicographic evidence and the
...
This course provides the theoretical background to using corpora in lexicographic practice. If you are interested in getting hands-on experience, we suggest continuing with the course [LEX2: Mastering ELEXIS Corpus Tools for Lexicographic Purposes](/resources/hosted/lex2-mastering-elexis-corpus-tools-for-lexicographic-purposes).
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/int-slips.png "Citation slips used in the compilation of the Dictionary of the Dutch Language")
...
*If you want a corpus that is representative of general English, a corpus of newspapers will not do.*

*If you want a corpus representative of English newspapers, a corpus containing only The Times will not do.*
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/dxu-uc-ldn8bayhpt-z6-o7c5y-m-re-ieof-kh-9-tl-7-u-kr-7-7-g12-f3-i-wdq3-dajo-jcsr-nt-v-jl-zmo-6-pni-spp-dixp-bayiq-jz-8-luiczvz-vvel5-bf-ca-hs-mq8t-xgg-sk7hyqw0-q6-dvaf2u-608.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/lcj-ig-eb0r-vh-jkds3p-r4-wp-rl-ogzb-di-uh-1-uc7-t9-vet-hy-wkf-sl-3fimdt-l7rd7-xl-qz7b5-lp1zy-zs-fq-ik-u2-eryy57-mqsi-tekpccv7-fa-uv-qz-r-sd-uye-fl-eo-11ny-evm-clf-wdg-s3og-am-j3h4.png)
...
Apart from the different names that are used for the tags, pos taggers can also differ in their approach, i.e. "functional" versus "lexical" tagging. For example, *walking* in the sentence *(The) walking is good for your health* will be tagged as a NOUN in a functional approach and as a VERB in a lexical approach. The UD annotation, for instance, is based on a lexicalist view of syntax.
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/19-g3-wxj-pk-ybglks-j-fk-nys-d0o-we-pxf-vi-j0k3-hrb-bz1-fxe-uy-gk-z-peo-uxy-71-hd4-pifymc-sbnk-ce-sg51-xl-6-d-sc8q85-fdu-fyqx-ns-lrz2e-qdzv-ww-bxs-nqx-rm8-zy-r8st-nd5-prw3f-yo-ay.png)
...
The figure below shows the extract from our text, POS tagged and lemmatised: ![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/uv-rgh-wt-3j-k7kn-rl-z-bmi5-nse-wr-dz-npi-l-exr-em-2-y-ttm-dukm-3svw-gy235-fp-mx9-g6-b-dbh-qtusov-s-bqlc-xdm-qhv-o-bkv-o-no-ry0-cx-fs6-gzs-o4obkwj-m-xyaiaw-zk9mi-l95y-y-am-pp-lz2-oe.png)

##### Syntactic annotation

Syntactic annotation provides information about the grammatical structure of sentences. This is also called parsing. Two types of parsers can be distinguished, those annotating constituent structures and those annotating dependencies (Figure taken from Jurafsky et al. 2021, Chapter 14, p.2). Syntactically annotated corpora are called treebanks as syntactic structures are commonly visualised in the form of trees. ![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/ug-k-za-x-xt-d3ktq-lc0-t3q-kn-ve-k-eg-tw-cyq-1-os-iu-s2ez1d-o-a-wn8m3x-kn-nb-wke-mhd-zww-orc-uo-qj-mds-f92-rnfn-haf-v57-t-td-rsr-yz-hsnr-4-f-ok-o-kg-quqv-8l-s9-bq-3-l-iha8c-j-lx-hm-a-hwvz.png) For a more computational description of dependency and constituency parsing, see Chapters 13 and 14 from [Jurafksy et al. 2021](https://web.stanford.edu/~jurafsky/slp3/).
...
The Figure below shows a sample UD annotation for English. ![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/j-cc-ld-0-iq3mlb8o7-6ci-my-p-drpwf-zjuu-4-aiwmmgz-71-c-jr-ymacs-flnsj-fww-tmmj-k0-rm-otp-b-rt-wa-lf-c2-bt-kb-e-kn-ce-2qap4cy-mcd94kq-qx-tssb-s-cgj-xj-5-ha-l-f78fs-m8k0-qcu-glbt.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/oe-stq-u-cy1o-po-mt-u-wh-l1y6-mqe-h8-afuj-an-sai9-bh-ba-t-pl-lb-9n2cn-n-agp9-o36-bkowj-e-yy-hq-uh9k-s-be-ng-w0begs-rdels9-pg-yi-l-fi-g-pzw-jz-wh-w-ydmg-vt-ghga-atjzg9-rme4-bq-81b6.png)
...
Most corpora that you will use, will contain various levels of linguistic annotation. Although automatic corpus processing and annotation tools provide excellent results, they are not flawless. Contractions, for instance, can sometimes be problematic in automatic processing. Is *aren't* considered as one token or as two, and if it is split into two tokens, which two - *are n't, or are not.* Different systems do different things. Compounds that can have different orthographic forms (i.e. written with or without a space or with a hyphen) can also cause problems. For example, *website* versus *web site*. Searching for *website* will not normally return hits for *web site* as automatic procedures do not lemmatise these to one and the same lemma form. Therefore you should always check how they are treated in your corpus. Finally, it is important to realise that we are dealing with authentic material and that this material may also contain errors or idiosyncratic instances.
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/rg-tg-qh-k7p-r-nu1pgvp-p-hqy2dm1de1wpip-llxj-cks-whm-lj-v7-xr-yklom-07-vtgs-cp-29-ywlzyvq-b5n-cg-jg-bve-al-lwypqx-qg0-slw-map-91s-hq-1-i-ia-at-d-boqeq-b-hd-z9-w-0-jv-hrwumbo-b4-np-c2-g9l-tcq.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/zifa-89-y-ek-r-ak-vc3-tn-jb-n-nwb-g-tvy-zbsz-q-sy-m-yr8-co4-sl-g45-z-sg-d-lja-xp-lv-z-rm-et-hr-qrd0-kn-bld-seq-zf-yrrigu4-z-pq-wptqdft4-bv8-w2-z-ai1-losq-6-iaw8z-uy-1-z-m6-xb-54-hutlx-iww-ba0-o-bqw.png)
...
*small own spare twin front main comfortable big large*
...
On the other hand, collocations which are typical, or strong, are far more useful. Typicality often brings up collocations which are not (completely) predictable. *Twin bedroom* is an example. A collocation list for bedroom ordered by the typicality score will look quite different with these items at the top:

*master double spacious spare en-suite upstairs twin guest air-conditioned*
...
Corpora can also help to identify the different senses of a polysemous word. For instance, by looking at the concordances (i.e. …) of the noun party in the example below, we see occurrences of the different senses of the noun party, i.e. party in the sense of political party, but also in the sense of a social event. ![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/r-j1r-fqv-9gu-lxd-p0-qqv-9or-x-mhy-b3-ocw8lyf-r-rrc-q-ogt-h-rzi-yh-x-nu-at-a8s-b2m-5du-arn2imy-xr53hrne1g-m0ze-pzb-ft-n-lt-rh0-nxzu-y-wb-jo-jx-yje-tv-z5-fs-q-aa-upx-29-eed8-h-ruf7-af-5u2-ca0q8-a.png)

These different senses can also be observed when looking at the word sketch of party:

![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/1-y-kprosso-h1o4bz5qw-o9r3-pa-tmy-e16-uk-yyy-ytz-ox-jmgm-8-ag-q-qj6-xqxx50l-bh1hhhtk1-kh-bd-cf-vo-dyd-mhc-26-efp-xg-6k5bz-qhs-yl-ei-gts-gh-i-fo-g-0-ep-qqel-gr2hqa-p-cvd31a8-c-zq4a-wu-e-yz-nug.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/it4u-gok-pfmw-hyt-npemd-hal-01-l8o-ucn-sx-1-ixkw-li-y-h-dr-gx-hfok1-tneg-rw-mbd-0-av-ku-o-ui-tpg-lt-n-nhd-bcbk-48odb66-goonj-55-yko-t5-mfz-vx-bkjb-fa-x14s-gxr-g7-a9-ic-vw-o4-c8vz-yr-pj-l0ndg.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/cii22e4-qw-q-lby-goy-ail-zx-rg-cs-07z6-x-seo-v6-gl-mpv-07-o-m-gqu-vg-zl0-fdsyj-ce2mm6q1fl-a3v-es4-bag-lb-g-gx-t5c-zq-gn-dhbhoyrx-ge-9qcwtt-vp-b-qx-nd-gi-vg-f-sa-dt5w-rq-gu-4-tgp-5i-og-tmy-yu-9lpc-a.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/uwi-k5-n7-eu-0-eyb3r-ycl-5kl-lo-9-yuq-hm-nb-wtzla-hk-iz-b-ur-s-fdgs-e-lo-gpx792ldkgt76-mwv-kds3fodls8x-x-bt-vp-p-jp-sddw-lrc-kd-3ly-s5-qy-zc-ladi-p646-zw-0-eo-bmx9e-tv-upk-h-zgt-efc-qt-oty5-ofwv-q.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/e-bo-y2x5nc-s2-sl-our-d-iigmiz-tij-4ekp-cd-tb-pu-o1-zo8-qiq-vm-a8u5-x-hv6nd-jeb4joe-wa-fx-jz-kzz-ysx-6-ofrb-foz-s-zp-hi-e-7-u-om-ih-1ve-f1-m-big1l-uya-nogo-u-rd1-sk-ax-sa-59-fb-e-z9410d-d-xc-b1-l5w.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/s-e77w-t-nc-em-mg-bk4-ub-n7xk-mlh-znq-7h-c8-n-oz-c-r9-c-f-adel-z-fyx1-g-n4-pxx-ol-eyv-i-b6c-wf-xwlrp7f-miz-c25-f1-h5-rrlm-th-xo-kto-r7-ifhh-0gm-jj-d-o-6-xn-u-pqv-p8-de-c2-hdw-n-ag-brn-zi42-f-qp-a.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/ks-9-kj-fr-e-xc-v-eq-ow-vt-i-amp6gff-bz-uum-17-c5-pa-2z2-gj-c-ti-w-d-fe-s-n-hzy-im-b0-bq-7ckk8y-fo0-n6tznwnxs4-oxe-4n6xy-hv-oyr-dx-mco-rtm-o-ia-r1s-yq0-km-8y-vny-su9-by-ie-h5l-wo-5ra-al-6k-ly-gvg.png)
...
![](/assets/content/assets/en/resources/hosted/introduction-to-corpus-based-lexicographic-practice/t-p9q-iu-gt-sqfzntwuo-7v-fu-on-bq-n-nr-ytjq4-e-qdp-dy7c-wpve-7iu-l2rke0-p-yv-np7co0n-ra6-i6a-b-x0f-jx-rkaiob-86r-lt-wp-tu4-ho-eb-auq-2-wu-oon-u-xg-xed06z-t-mx-ox-neql-pumbn-ki-cbpzlp-lb-deyq.png)
...
[https://www.sketchengine.eu/my\_keywords/token/](https://www.sketchengine.eu/my_keywords/token/)

[https://www.sketchengine.eu/my\_keywords/word/](https://www.sketchengine.eu/my_keywords/word/)

#### Frequency

The frequency is the basic statistics in corpora. It refers to the number of hits (the number of times the search word or phrase was found). It can only be used to compare information derived from the same corpus. It cannot be used to compare two different corpora because two corpora have different corpus sizes and, naturally, a larger corpus will produce a higher frequency than the smaller corpus. See also [https://www.sketchengine.eu/my\_keywords/frequency/](https://www.sketchengine.eu/my_keywords/frequency/)

#### Relative frequency, normalized frequency, frequency per million

All three terms refer to the same statistic. Relative frequency is used to compare information derived from corpora of different sizes. The value does not depend on the corpus size. Sketch Engine uses frequency per million. Thus, a relative  frequency of 10 per million means that there are 10 hits in each million tokens on average. If the corpus is smaller than a million, it indicates what the frequency would be if the corpus had a million tokens. See also [https://www.sketchengine.eu/my\_keywords/freqmill/](https://www.sketchengine.eu/my_keywords/freqmill/)
...
See also [https://www.sketchengine.eu/my\_keywords/t-score/](https://www.sketchengine.eu/my_keywords/t-score/)
...
See also [https://www.sketchengine.eu/my\_keywords/mi-score/](https://www.sketchengine.eu/my_keywords/mi-score/)
...
See also [https://www.sketchengine.eu/my\_keywords/logdice/](https://www.sketchengine.eu/my_keywords/logdice/)
...
The score used in Sketch Engine is called Simple Maths. It is used to identify keywords (single word items), terms (mutliword items), key n-grams and also key collocations. See also [https://www.sketchengine.eu/my\_keywords/simple-maths/](https://www.sketchengine.eu/my_keywords/simple-maths/)

## Next steps

This course provided you with the necessary theoretical background to use corpora in lexicographic practice. If you are interested in getting hands-on experience, we suggest continuing with the course [LEX2: Mastering ELEXIS Corpus Tools for Lexicographic Purposes](/resources/hosted/lex2-mastering-elexis-corpus-tools-for-lexicographic-purposes).
...
Wortel, D. (1997). Het woordenboekcitaat in de oudste WNT-delen. In Voortgang. Jaarboek voor de Neerlandistiek, 17. 191-206. Available at: [https://www.dbnl.org/tekst/\_voo004199701\_01/\_voo004199701\_01\_0009.php](https://www.dbnl.org/tekst/_voo004199701_01/_voo004199701_01_0009.php) (accessed 23 July 2021)
