...
summary:
  content: This course provides a comprehensive understanding of Europeana as a
    ...
    understand the purpose they serve and the functionality they have, to
    exploit them by formulating efficient queries for cultural heritage
    information retrieval. Building on use cases, it delves into the APIs
    required to achieve research goals, exploring their features and providing
...
4. ***IIIF APIs***: following the specifications of the [International Image Interoperability Framework (IIIF) consortium](https://iiif.io/community/consortium/), this set of APIs includes:
...
8. ***SPARQL***: allows users to query Europeana.eu and explore connections with external sources using [SPARQL](https://www.w3.org/TR/sparql11-query/), a [W3C](https://www.w3.org/) recommendation query language for querying semantic data expressed in [RDF](https://www.w3.org/RDF/).
9. ***OAI-PMH***: allows metadata harvesting using the [Open Archives Initiative Protocol for Metadata Harvesting (OAI-PMH)](https://www.openarchives.org/pmh/).
...
<Embed src="/assets/content/assets/en/resources/hosted/introduction-to-europeana-apis/apis.png">
  Fig. 1: Screenshot of the Europeana APIs landing page ([https://apis.europeana.eu/en](https://apis.europeana.eu/en))
</Embed>
...
<Embed src="/assets/content/assets/en/resources/hosted/introduction-to-europeana-apis/yourkey.png">
