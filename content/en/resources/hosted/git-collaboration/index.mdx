...
<Callout kind title="Git hosting providers">
...
<Callout kind title="Working with VS Code and GitLab">
...
<Embed src="/assets/content/assets/en/resources/hosted/git-collaboration/gitlab-com-preferences.png">
  gitlab.oeaw\.ac.at user preference
</Embed>

On the left side select "**Access Tokens**"

<Embed src="/assets/content/assets/en/resources/hosted/git-collaboration/gitlab-com-access-tokens.png">
...
<Embed src="/assets/content/assets/en/resources/hosted/git-collaboration/gitlab-com-all-access-token.png">
...
<Embed src="/assets/content/assets/en/resources/hosted/git-collaboration/gitlab-com-access-token-generated.png">
