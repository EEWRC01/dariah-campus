...
summary:
  content: The course will focus on modeling dictionaries using TEI Lex-0, a
...
![Good news for people who love bad news](images/5-w4-fyo-0.jpg "CC BY-ND Olivia Mew")
...
The following table contains a list of all TEI modules with links to the chapters of the *TEI Guidelines* where they are defined.
...
As you can see, *The TEI Guidelines* are themselves quite massive. Finding your way around may be difficult at first. We'll be focusing on Chapter 9: Print Dictionaries, which will make your job somewhat easier.
...
Sometimes, however, it will be more useful for you to look up the declarations and examples of particular TEI elements, such as `<entry>`, `<sense>` or `<def>`. In those situations, instead of going through the dictionary chapter, it will be easier for you to consult the *[Appendix C](http://www.tei-c.org/release/doc/tei-p5-doc/en/html/REF-ELEMENTS.html)* of *The Guidelines*, which contains an alphabetic list of all the TEI Elements.
