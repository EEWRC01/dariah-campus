...
locale: en
publication-date: 2024-09-16T16:14:26.180Z
version: 1.0.0
authors:
  - baille-james
editors:
...
summary:
  title: An Introduction to Prosopography
  content: This resource helps students tackle key prosopography challenges, such
    as disambiguating individuals with the same name, handling anonymous
    entries, and recognizing fictional people, known as the Rusudan Problem.
    Additionally, this resource focuses on the theory of identity, where roles,
    titles, and historical presence may be disputed but still carry an assumed
    "correct" interpretation. Fluid identities—such as ethnicity, gender, and
    religion—are more complex and require careful modeling in databases. The
    course also covers how to scope projects effectively by defining clear
