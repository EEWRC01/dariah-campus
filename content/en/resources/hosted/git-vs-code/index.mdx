...
<Callout kind title="The tell me who you are - message">
...
<Callout kind title="Unfortunately this differs again between the three operating systems">
  <Tabs>
    <Tab title="Windows">
      ### Windows
    ...
    <Tab title="MacOS">
      ...
      ![](/assets/content/assets/en/resources/hosted/git-vs-code/first-time-terminal-macos.png "first time terminal MacOS")
    </Tab>
