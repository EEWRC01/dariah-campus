...
<Embed src="/assets/content/assets/en/resources/hosted/git-version-control-via-command-line/git_terminology.png">
  Git workflow
</Embed>
...
<SideNote type="note" title="Git for Windows, Mac, Linux">
  <Tabs>
    <Tab title="Windows">
...
<Embed src="/assets/content/assets/en/resources/hosted/git-version-control-via-command-line/git_initialise_empty_gitrepo.png">
...
<Embed src="/assets/content/assets/en/resources/hosted/git-version-control-via-command-line/add_file_status.png">
...
<SideNote type="note" title="Diffing not-yet-committed work">
