...
<Embed src="/assets/content/assets/en/resources/hosted/git-version-control-via-command-line/branches-png">
...
<Embed src="/assets/content/assets/en/resources/hosted/git-version-control-via-command-line/git-terminology-png">
  Git workflow
</Embed>
...
<Callout kind title="Git for Windows, Mac, Linux">
  <Tabs>
    <Tab title="Windows">
...
<Embed src="/assets/content/assets/en/resources/hosted/git-version-control-via-command-line/git-initialise-empty-gitrepo-png">
...
<Embed src="/assets/content/assets/en/resources/hosted/git-version-control-via-command-line/add-file-status-png">
...
<Callout kind title="Adding multiple files">
...
<Callout kind title="Commit messages">
...
<Callout kind title="Diffing not-yet-committed work">
