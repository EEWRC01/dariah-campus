...
<VideoCard provider="youtube" id="ifTYfDF6pUI" title="Introduction to APIs" image="/assets/content/assets/en/resources/hosted/introduction-to-apis/intro-to-apis-image-png" subtitle="Click here to view" />
