...
![Print Dictionary to Machine Readable Text](images/a18wpcc.png)
...
Once you've learned the basics of working with XML, you can explore XPath, a standard query language for selecting nodes from XML documents. [Extracting Lexical Data: XPath for Dictionary Nerds](/id/XUDsnt3PCB0WTEr-6EM7w) may be a good place to start.
...
![](images/s1ii-ww-e.png)

As part of the ELEXIS Curriculum on DARIAH-Campus, we offer an introductory course on [Transforming Lexical Data: XSLT for Dictionary Nerds](/id/DPF60ESE5Bf1jmjtPXzWI).
...
3. Select "XML Document". Doing this should open up a blank document with an XML declaration `<?xml version="1.0" encoding="UTF-8"?>` added. One thing you will notice, however, is a red marker in the right margin of your document, and an error message at the bottom reading "A well-formed document requires a root element." ![](images/w-defn-sg.png)
   ...
   Once you do add the above, the error about your file being not well-formed will dissappear, the red marker in right margin will turn to green, and oXygen will purr with happiness. Ok, the last bit won't happen, but oXygen will keep track of your XML file all the time, letting you know when things go frong. ![](images/px-0z-b-gq.png)
...
1. Click on the "Fromat and indent" icon or select Document > Source > Format and indent. ![](images/o-qb-sxd2.png)
2. As a result, your XML will be reformatted for your viewing pleasure. ![](images/0n-tp-o6-n.png)
...
Keep in mind, there is a lot more to learn about oXygen. If you're interested, make sure to check out the ELEXIS course [Mastering oXygen XML Editor for Dictionary Nerds](/id/CPYfBfo_5Rz1d8tow9Gfu) here on DARIAH-Campus.
...
The creation of user interfaces and storage of digitized lexical datasets in databases is beyond the scope of this course. You may, however, be interested in the ELEXIS course [How to Publish Your Dictionary Data with Publex](/id/CPYfBfo_5Rz1d8tow9Gfu) here on DARIAH-Campus.
