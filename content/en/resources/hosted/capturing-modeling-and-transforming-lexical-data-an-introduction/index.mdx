...
summary:
  content: This course will introduce the theories, practices, and methods of
    digitizing legacy dictionaries for research, preservation and online
    distribution by focusing on the process of converting paper-based
    dictionaries to electronic format through image capture, text capture, data
    modeling and data enrichment.
...
<Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/n-nw9-ti-3l-jpg">
...
* study *extremely* carefully the funding agency's instructions: make note of the deadlines, application requirements (structure, maximum number of pages, font, font size etc.) Make sure to include all the required documents (budget calculations, letters of commitment, CVs etc.)
...
![Print Dictionary to Machine Readable Text](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/a18wpcc.png)
...
*Please note in all cases that a bit depth of 8 and a resolution of 400ppi is the minimum recommended where Optical Character Recognition is to be applied. For very small text, a resolution of 600ppi is recommended.*
...
<Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/g-l9q7-ir-png">
  OCRing this German-Serbian dictionary produces mostly gibberish
</Embed>

Fortunately, there are also numerous dictionaries, especially the more modern ones, which can be handled well by OCR.

![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/vw-nw-e7m.png)
...
<Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/ib-l-rh2-v-png">
  Example 1. Linde Dictionary: decent OCR by the ABBYY Cloud OCR service.
</Embed>

**Czech-Polish Dictionary**

<Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/zi-r7o-xj-png">
  Example 2. Czech-Polish dictionary: here also the OCR result is quite decent.
</Embed>

**Rechnik malyj**

<Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/r8-os-t9-c-png">
  Example 3. Rechnik Malyj: the German OCR works a bit, the (old style) Cyrillic is useless.
</Embed>

**Mikloshich**

<Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/i7e5-k-jd-png">
  Example 4. Mikloshich, Old Slavonic-Greek dictionary: again, the old-style Cyrillic is hopeless.
</Embed>

**Serbian Etymological Dictionary**

<Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/m-mp-tas-w-png">
  Example 5. Serbian Etymological Dictionary: The OCR of modern Cyrillic is of acceptable quality
</Embed>

**Grimm**

<Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/lcg-mew-v-png">
  Example 6. Grimm: OCR is reasonable, but could have been better with a higher resolution image.
</Embed>

**Bernolak**

<Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/a2cy-sik-png">
  Example 7. The Bernolak dictionary: rather bad OCR.
</Embed>

**Warsaw Dictionary**

<Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/w8v-bd-d4-png">
  Example 8. The Warsaw dictionary.
</Embed>
...
It is beyond the scope of this course to explore this area. If you are intersted, we recommend that you learn more about [Transkribus](https://transkribus.eu) and their [How-to guide](https://transkribus.eu/Transkribus/docs/How%20to%20use%20TRANSKRIBUS-0.1.7.pdf) and [eScriptorium](https://www.resilience-ri.eu/blog/resilience-tool-escriptorium/).
...
<Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/m7-kg-r-cc-png">
...
* DFG: [http://www.dfg.de/formulare/12\_151/12\_151\_de.pdf](http://www.dfg.de/formulare/12_151/12_151_de.pdf) (in German)
...
Data enrichment covers not only metadata *about* the dictionary itself (structured information that can then, for instance, become part of a library catalogue), but also, various bits of information that can be added to the dictionary content, for instance: expansion of abbreviations, geolocations of place names, etc.
...
<Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/vr-vwm-xy-jpg">
...
<Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/kz6-bam-8m-jpg">
...
<Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/bg-yaa-8o-jpg" />
...
![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/0p-h-ez-si.jpg)
...
XML (or eXtensible Markup Language), like SGML before it, defines a set of rules for encoding texts. Unlike a natural language, which consists of identifiable and definable words, XML, on its own, gives you an apparatus for *creating* "words" or what we in XML lingo call *elements*.
...
To help enforce uniformity in element naming and syntax, SGML used a language called  **Document Type Definition (DTD)**. DTDs are a set of rules that specify what elements are used in an SGML/XML document, how frequently they can be used, at which position in the document hierarchy etc. In the context of dictionaries, a DTD would contain rules that would tell you: an entry *must* contain a lemma, *can* contain grammatical information, and *can* contain one or more senses. A dictionary entry is imaginable without grammatical information, but not without a lemma. Similarly, a dictionary entry can contain one or more senses, but it doesn't have to, because instead of senses, we may encounter a cross-reference.
...
* fine-grained searchability; and
* transformability.
...
XML-encoded texts can offer a high degree of precise, fine-grained searchability. In a plain-text search, all strings are considered equal and your text edtior will return all the hits containing the search string, regardless of its position in the dictionary hierarchy. This can be ok for quick-and-dirty searches, but it can also produce a lot of noise, if we are looking for something really specific.

In an XML-encoded dictionary, you can create separate searches through dictionary lemmas, definitions, examples etc. as long as you know the names of the tags used to mark up these particular structural elements of the dictionary.

Once you've learned the basics of working with XML, you can explore XPath, a standard query language for selecting nodes from XML documents. [Extracting Lexical Data: XPath for Dictionary Nerds](/resources/hosted/xpath-for-dictionary-nerds) may be a good place to start.

##### Transformability

Another advantage of XML-encoded documents is that they are trasnformable: using an XML parser, a software developed to access and manipulate XML documents and XSLT (Extensible Stylesheet Language Transformations), a standard programming language for transforming XML documents, XML-encoded data can be converted to different formats such as HTML (for display in a web-browser), PDF etc.

![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/s1ii-ww-e.png)

As part of the ELEXIS Curriculum on DARIAH-Campus, we offer an introductory course on [Transforming Lexical Data: XSLT for Dictionary Nerds](/resources/hosted/transforming-lexical-data-xslt-for-dictionary-nerds).

## XML: Building blocks and basic rules

### Tree structure

XML documents have a hierarchical structure: this means that they consists of various nested components that have a clear relationship to each other. This hierarchical structure is often described as a tree structure.

The **root** element forms the basis of the XML tree and all other componenets reach out like branches and leaves from this topmost element
...
![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/p-sfhfx4.png)
...
![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/boxes.png)
...
![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/folders.png)

We'll look more closely into the relatinships between different components of the XML tree later in this course, but before we do that, we should explore different types of componenets that make up the XML document.
...
As we already mentioned above, the structure of an XML document is a tree structure. The root element, forms the basis of the XML tree and all other element nodes, attribute nodes and text nodes reach out like braches and leaves.

This makes it possible and necessary for us to speak of the various relationships that exist between various building blocks of the XML tree.

In the **child-parent relationship** one element (the child) is nested inside another element (the parent). In the following example, the element `<lemma>` is nested in the element `<entry>`. Consequently, `<lemma>` is the child of `<entry>` and `<entry>` the parent of `<lemma>`.
...
This is all fine and dandy, but how does one *actually* work with XML files in an XML editor? In this section, we'll show you how to create a new XML file, insert an unmarked dictionary entry in it, and then mark it up. You will learn how to check that your document is well-formed, and then format-and-indent it — all this using an XML editor called [oXygen](https://www.oxygenxml.com).
...
2. Select File > New and make the contents of the New Document folder visible by clicking on it. Alternatively, type in "xml" in search field.
   ...
   <Embed src="/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/le073-bh-png" />

3. Select "XML Document". Doing this should open up a blank document with an XML declaration `<?xml version="1.0" encoding="UTF-8"?>` added. One thing you will notice, however, is a red marker in the right margin of your document, and an error message at the bottom reading "A well-formed document requires a root element." ![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/w-defn-sg.png)
   ...
   Once you do add the above, the error about your file being not well-formed will dissappear, the red marker in right margin will turn to green, and oXygen will purr with happiness. Ok, the last bit won't happen, but oXygen will keep track of your XML file all the time, letting you know when things go frong. ![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/px-0z-b-gq.png)
...
1. Click on the "Fromat and indent" icon or select Document > Source > Format and indent. ![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/o-qb-sxd2.png)
2. As a result, your XML will be reformatted for your viewing pleasure. ![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/0n-tp-o6-n.png)
...
![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/4s-chb-kf.png)
...
![](/assets/content/assets/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/oavd-vs-i.png)

### Smart editing

oXygen includes *smart editing* features to help you edit XML documents in Text mode. These include, for instance:
...
Keep in mind, there is a lot more to learn about oXygen. If you're interested, make sure to check out the ELEXIS course [Mastering oXygen XML Editor for Dictionary Nerds](/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds) here on DARIAH-Campus.
...
The creation of user interfaces and storage of digitized lexical datasets in databases is beyond the scope of this course. You may, however, be interested in the ELEXIS course [How to Publish Your Dictionary Data with Publex](/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds) here on DARIAH-Campus.
