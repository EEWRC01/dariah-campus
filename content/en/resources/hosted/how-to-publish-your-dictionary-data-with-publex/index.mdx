...
summary:
  content: This course introduces Publex, a modern, generic, modular dictionary
    publication tool for retrodigitized / legacy dictionaries.
...
![Upload](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/upload.svg)
...
![Configuration](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/configuration.svg)
...
![Publication](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/publication.svg)
...
![Register](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/register.svg)
...
![Login](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/login.svg)

If you already have a user account, you can log in to the home page with your registered e-mail address and your password.

### Logout

![Logout](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/logout.svg)

Within Publex, you can log out of your profile at any time using the logout icon in the top menu bar.

### Forgot your password?

![Forgot password](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/password.svg)
...
![Profile](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/profile.svg)
...
* The files are required to be provided in **valid XML**. (We recommend providing the data according to the [guidelines of TEI Lex-0](https://dariah-eric.github.io/lexicalresources/pages/TEILex0/TEILex0.html).)
...
1. Check whether your special characters are contained in the [allEntities](https://bitbucket.org/tcdh/publex-allentities/src/master/allEntities.xml) file. For this, you can explore the KompLett font in the GlyphrStudio web tool:

* Load the file KompLettR.ttf you find [here](https://bitbucket.org/tcdh/publex-allentities/src/master/KompLett_R.ttf) into [Glyphr Studio](http://www.glyphrstudio.com/online) and make sure you choose to import all glyphs:

![Import Komplett Font file](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/glyphr-studio-load-a-file.png)

![](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/glyphr-studio-import-all.png)
...
![](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/glyphr-studio-private-use-area.png)

2. When you have found your desired character in the overview, **find out its position**. To do this, move the mouse over the character. The position is displayed in a mouseover after the string "Private Use Area". In the following example it is "EA4C".

![](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/glyphr-studio-zeichenansicht.png)

3. Using the position number, **look up the character's name** in the [allEntities file](https://bitbucket.org/tcdh/publex-allentities/src/master/allEntities.xml).
...
![u with superscripted plus (entity file)](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/uplusabove.png)

4. In the XML file of your dictionary text, replace the corresponding special character with `&entity name;` (entity name = "plusaboveu" in the following example; used as "\&plusaboveu;").

![u with superscripted plus (xml)](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/uplusabove-xml.png)

And this is how the character is finally displayed using the KomplettFont:

![u with superscripted plus (displayed)](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/uplusabove-wbnetz.png)

<Callout kind="note">
  The allEntities file must be uploaded with the dictionary files during import.
  How this works, you will find out [here](#import). To display the special
  characters in the published dictionary, it is necessary to select the KompLett
  font in the configuration. Details can be found in [this
  section](#define-your-styling-rules).
</Callout>

<Callout kind>
  You *don't need* the allEntities file if your special characters are all
  defined in the Unicode standard and if you encode all your special characters
  with hexadecimals codes. - If you have special characters in your dictionary
  that are **neither defined in the Unicode Standard nor in our allEntities**,
  please contact the Publex team
  \[[kompetenzzentrum@uni-trier.de](mailto:kompetenzzentrum@uni-trier.de)].
</Callout>
...
![Welcome page Bitbucket](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/home-bitbucket.png)

![Create new repository](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/new-repo.png)
...
![New repository](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/new-repo.png)
...
![Copy clone command](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/clone-command.png)
...
![Dictionary Overview](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/dictionary-overview.png)

2. A new window opens. Type in the **name** of your new dictionary and optionally a description.

![Add new dictionary](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/new-dictionary.png)
...
1. There are two possible ways to get to the **import page**: a) You create a new dictionary and immediately go to the XML file import (see [here](#creating-a-new-dictionary)). b) In the Dictionary Overview, select a dictionary that has already been created and click on **"Edit Dictionary"**.
   ...
   ![Edit dictionary](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/edit-dictionary.png)

In the menu bar on the left, under **"Dictionary Management"**, select **"XML File Import"**.

![Left menu bar](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/left-menu.png)

2. Now you have to provide Publex with the information where to find your dictionary data.

![Define import](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/import-data.png)
...
![Clone Button](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/clone-button-bitbucket.png)

![Repo URL](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/clone-ssh.png)
...
1. If your repository is public, no further settings are necessary for the import. If it is a private repository, please mark the checkbox "This is a private Git repository!".
   ...
   ![Private Git](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/privategit.png)
2. By activating the button, a SSH key becomes visible. Please add this key to your Bitbucket account.

* Copy the key.
* In your Bitbucket account, go to your personal settings (see the settings-icon in the upper right corner).

![Personal settings](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/bitbucket-personal-settings.png)
...
* In personal settings, go to "SSH keys" and click on "Add key". A Window opens where you can paste your key you copied from Publex.
  ...
  ![Add key](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/add-key.png)
...
* ![Test\_Git](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/button-test-git.png)
...
![Delete dictionary](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/delete-dictionary.png)
...
![Lock a dictionary](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/lock-dictionary.png)

![Locked dictionary](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/locked-dictionary.png)
...
![](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/edit-dictionary.png)

![Metadata Management](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/metadata-management.png)
...
![Dictionary Categories](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/metadata-categories.png)
...
* The order can be modified at any time using the arrow buttons.
  ...
  ![Change Order](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/arrows.png)

<Callout kind="tip" title="Advice for the choice of font">
...
![Add new sytyling rule](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/add-new-rule.svg)
...
![Name rule](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/name-rule.png)
...
![Dropdown menu tags](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/tag-choice.png)

Now you have different options:

1. **You select only one element tag**. The rule then applies to all elements with this tag name, regardless of the attributes: ![Only tag](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/only-tag.png)
...
![add attribute](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/add-attribute.png)

![attributes](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/attributes.png)
...
![add value](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/add-value.png)

![tag, attribute, value](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/attribute-values.png)

Attributes and attribute values that have already been selected can be removed with the minus symbol on the right.

![delete attribute](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/delete-attribute.png)

### Search and lemma field

For each rule, there are different options you can select in the settings:

![settings](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/settings.png)
...
![Styling functions I](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/styling-functions-1.png)

![Styling functions II](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/styling-functions-2.png)

Planned additional formatting functions:

![Styling functions II](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/styling-functions-3.png)

### Save and discard

When you have defined a new rule or made changes, save them with the save button at the top of the right.

![Save](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/save.png)

Single rules can be deleted via the bin button.

![Delete rule](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/delete-rule.png)
...
![Discard changes](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/discard-changes.png)
...
![Lock rule](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/lock-rule.png)
...
![Export and Import Styling Rules](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/export-import.png)
...
![Import Styling Rules](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/import-config.png)

After clicking on "OK", the rules are imported and displayed.

<Callout kind="warning" title="Saving">
...
![Lexer bluome Foto](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/bluome-categories.png)

This is how the XML annotated entry looks like:

![Lexer bluome XML](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/bluome-xml.png)
...
![information types](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/information-types.png)

![typograhocal types](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/typo-types.png)
...
![entry rule](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/entry-rule.png)
...
![Defining lemma rule](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/lemma-rule.png)
...
![Defining grammar rule](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/grammar-rule.png)

#### Definition

The text contained in `<def>` should also be set in italics. We additionally activate the checkbox "Set as searchable field".

![Defining definition rule](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/def-rule.png)

#### Citation

Quoted examples are coded with `<cit type="example">` and should be displayed in green.

![Defining citation rule](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/citation-rule.png)
...
![Defining author rule](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/author-rule.png)
...
![Defining italics rule](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/superscript-rule.png)

![Defining recte rule](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/recte-rule.png)

![Defining superscript rule](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/superscript-rule.png)
...
<Callout kind="tip">
  ...
  representation of your dictionary in the [dictionary
  preview](#the-dictionary-viewer:-preview-your-dictionary).
</Callout>

In the dictionary preview, our example entry *bluome* now looks like this:

![Preview entry bluome](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/bluome-preview.png)
...
![Preview Website Left Menu](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/left-menu-preview.png)

Or by going to your dictionary in the Dictionary Overview and click on "Preview Website":

![Preview Website Overview](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/preview-website.png)

A new tab opens in the browser with the preview:

![Dictionary Viewer](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/dictionary-viewer.png)
...
![Search lemma list](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/lemmalist-search.png)

### The dictionary look-up

In the dictionary look-up the user has the choice between a general fulltext search

![simple search](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/simple-search.png)

and an advanced search.

![advanced search](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/advanced-search.png)

The advanced search offers a fulltext search and search options in all information fields the checkbox "set as searchable field" has been activated for in the styling rules (see [here](#search-and-lemma-field)). In our example configuration, these are the lemma, the grammatical information, the definition and the source information.
...
![Search result](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/search-result2.png)
...
![Publication](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/publication-button.png)
...
![Publex Button](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/publex-button.png)
...
![Published Dictionaries](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/published-dictionaries.png)
...
![Reverse a publication](/assets/content/assets/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/unpublish-button.png)
...
For further information see the [Publex homepage](https://tcdh.uni-trier.de/en/projekt/publex).
