...
summary:
  content: This course will help users learn how to use oXygen XML, a versatile,
...
![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/gry-le-ov.png)
...
![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/0-odw-z-bl.png)
...
<Callout kind title="What's where?">
...
![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/r-ou-kxh-u.png)
...
![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/k-cv-agi-v.png)
...
![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/hb-10n6-a.png)
...
![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/h8w-qg-zd.png)
...
3. Start typing `form` inside the menu.
   ...
   ![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/1k-n-kp-zk.png)
...
4. Once you see the `form` element selected in the dropdown, click the OK button. This will wrapp the selected word with `<form></form>`.
   ...
   ![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/g-sl6u-cj.png)

5. Since `Lexico'grapher` is still selected, you can press `Command + E`/`Ctrl + E` again and choose `orth` from the dropdown.

   ![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/od6-xm-2-d.png)

   This will wrap the content in the `orth` element inside the `form` element.
   ![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/t-ekr-sqs.png)

<Callout kind title="Takeaway">
...
![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/ryez-gn-v.png)
...
![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/7tc-w-kzu.png)

<Callout kind="note" title="Takeaways">
...
![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/383s-mo-y.png)
...
1. Open the `dictionary.xml` file, in case you don't already have it open. You will most likely see something like this:
   ![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/l-yrt-o9-l.png)
2. Remove the manually created `<form></form>` and `<orth></orth>` tags. Ideally, you should do this by clicking within the word "Lexicographer" and then using the default "Delete element" shortcut that we introduced above. You should then reuse the same shortcut to get rid of the `<form></form>` tags. If you don't remember the shortcut, you can look it up above -- or inside your oXygen preference. You should then be seeing this:
   ![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/xv-nb-pvb.png)
3. Now, select the word "Lexicographer" and press `Command` + `Space` (on macOS) / `Ctrl` + `Space` (on Windows) to retrieve a content completion list. You should get a list of your custom code templates. Since we have only just created one, you should be seeing this:
   ![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/y3-zi7-bb.png)
...
<Callout kind="note" title="Takeaways">
  1. Code templates and custom shortcuts are *very* cool.
...
![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/rim-5-znb.png)

### Grid Mode

When you switch to Grid Mode, your sample entry should now look like this:

![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/wd-0h-ywo.png)
...
![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/g-wx-f8-hd.png)
...
![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/m-hsf-dbd.png)
...
![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/cfi-vo8e.png)
...
![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/hsz-am-zv.png)
...
<Callout kind="note" title="Frameworks in oXygen">
...
4. Click on the icon with a green arrow and select `${pd} - Project directory` from the dropdown. Add `/frameworks` to the input field. This will tell oXygen to look for framework definitions inside the frameworks folder inside the project directory. Click OK.
   ![](/assets/content/assets/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/ia-xg-ego.png)
5. Click Apply.
