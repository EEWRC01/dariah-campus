...
summary:
  content: Thesauri, taxonomies and other forms of controlled vocabularies
    represent a conceptual backbone of the research, playing an ever-increasing
    role in various aspects of the data management process.  These resources are
    indispensable to determine common understanding allowing to systematically
    categorize and enrich research data in a consistent manner, as well as
    foster the data interoperability and integration among projects and web
    applications.
...
<VideoCard provider="youtube" id="DUlfC8NL0Bs" title="Controlled Vocabularies and SKOS" image="/assets/content/assets/en/resources/hosted/controlled-vocabularies-and-skos/cv-and-skos-title-image-jpg" subtitle="Click to view" />
...
**Diagram 1.** below shows how controlled vocabularies are embedded in architecture of an information system (the example is derived from [DEFC controlled vocabulary](https://vocabs.acdh.oeaw.ac.at/defc_thesaurus/en/)). In this example, the Archeological site is a Universal abstract class, whereas Athens is an instance of Archaeological site class and a Particular that represents the exact and real archaeological site studied and described in the system. Athens can be of one or many types that are defined in a controlled vocabulary, for example, it can be a type of 'Hillside'.

![Diagram 1. Controlled vocabularies in data architecture](/assets/content/assets/en/resources/hosted/controlled-vocabularies-and-skos/cv-and-skos-model-diagram-1.png)
...
![BBT - Backbone Thesaurus in Vocabs repository](/assets/content/assets/en/resources/hosted/controlled-vocabularies-and-skos/bbt.png)
...
Informative guide [SKOS Primer](https://www.w3.org/TR/skos-primer/) .

Normative guide [SKOS Reference](https://www.w3.org/TR/skos-reference/) intended for users who have a good understanding of Semantic Web technology, especially RDF and OWL [SKOS Reference](https://www.w3.org/TR/skos-reference/) .
...
> "Concepts exist in the mind as abstract entities which are independent of the terms used to label them." [SKOS Primer](https://www.w3.org/TR/skos-primer/)
...
Sometimes it is required to describe relationships among lexical labels representing concepts. For this SKOS provides an extension SKOS-XL - [SKOS eXtension for Labels](https://www.w3.org/TR/skos-reference/skos-xl.html) - to identify, describe and link lexical labels.
...
<Quiz>
  <QuizChoice variant="multiple">
    <QuizChoiceQuestion>
      **Select all triples with *correct* RDF syntax.** *Please, assume the following prefixes for all options:*

      ```turtle
      @prefix skos: <http://www.w3.org/2004/02/skos/core#> .
      @prefix ex: <http://www.example.org/cats#> .
      @prefix wikidata: <http://www.wikidata.org/entity/> .
      ```
    </QuizChoiceQuestion>

    <QuizChoiceAnswer kind="incorrect">
      `ex:europeanWildcat a skos Concept; skos prefLabel "European wildcat"@en.`
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      `ex:europeanWildcat rdf:type skos:Concept; skos:preflabel "European wildcat"@en.`
    </QuizChoiceAnswer>
  ...
  <QuizChoice variant="multiple">
    <QuizChoiceQuestion>
      **Select all *correct* SKOS records.** *Please, assume the following prefixes for all options:*
    ...
    <QuizChoiceAnswer kind="incorrect">
      `ex:eurasianLynx a skos:Concept; skos:prefLabel "Eurasian lynx"@en; skos:prefLabel "Lynx"@en.`
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      `ex:eurasianLynx a skos:Concept; skos:prefLabel "Eurasian lynx"@en; skos:prefLabel "Eurasischer Luchs"@de.`
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      `ex:eurasianLynx a skos:Concept; skos:prefLabel "Eurasian lynx"@en; skos:altLabel "Lynx"@en.`
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      `ex:eurasianLynx a skos:Concept; skos:prefLabel "Eurasian lynx"@en; skos:prefLabel "Eurasischer Luchs"@en.`
    </QuizChoiceAnswer>
  </QuizChoice>

  <QuizChoice variant="multiple">
    <QuizChoiceQuestion>
      **Select all *incorrect* SKOS records.** *Please, assume the following prefixes for all options:*
    ...
    <QuizChoiceAnswer kind="correct">
      `ex:europeanWildcat a skos:Concept; skos:exactMatch ex:eurasianLynx.`
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      `ex:europeanWildcat a skos:Concept; skos:exactMatch wikidata:Q148833.`
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      `ex:europeanWildcat a skos:Concept; skos:broader ex:wildcat; skos:broadMatch ex:wildcat.`
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      `ex:europeanWildcat a skos:Concept; skos:broader ex:wildcat; skos:broadMatch wikidata:Q43576.`
    </QuizChoiceAnswer>
  </QuizChoice>
  ...
  <QuizChoice variant="multiple">
    ...
    <QuizChoiceAnswer kind="correct">
      Concept can be a top Concept of Concept Scheme and have a broader Concept in this Concept Scheme.
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      Concept can have several preferred labels in one language.
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      Concept can be broader and narrower of another Concept at the same time.
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      Concept can have several alternative labels in one language.
    </QuizChoiceAnswer>
  </QuizChoice>
  ...
  <QuizChoice variant="multiple">
    ...
    <QuizChoiceAnswer kind="correct">
      Concept can't have more than one preferred label in one language.
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="incorrect">
      It is recommended to create a new Concept for each synonym of a term.
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      Concept can have a broader matching concept in another Concept Scheme and can be linked to it.
    </QuizChoiceAnswer>

    <QuizChoiceAnswer kind="correct">
      Concept can have many matching Concepts in external Concept Schemas.
    </QuizChoiceAnswer>
  </QuizChoice>
</Quiz>
...
![Picture 2. Controlled vocabularies in IAD curation interface](/assets/content/assets/en/resources/hosted/controlled-vocabularies-and-skos/cv-in-curation-interface.png)
...
![Picture 3. Pop up with a vocabulary term definition and traslations in user interface](/assets/content/assets/en/resources/hosted/controlled-vocabularies-and-skos/cv-popup-in-userinterface.png)

* Faceted search is based on CVs: dropdowns and autocompletes

Picture 4. CV in faceted search interface

![Picture 4. Controlled vocabularies in IAD search interface](/assets/content/assets/en/resources/hosted/controlled-vocabularies-and-skos/cv-in-search-interface-01.png)

Picture 5. CV in faceted search interface

![Picture 5. Controlled vocabularies in IAD search interface](/assets/content/assets/en/resources/hosted/controlled-vocabularies-and-skos/cv-in-search-interface-02.png)
...
![Picture 6. IAD - Iron-Age-Danube Thesaurus in Vocabs repository](/assets/content/assets/en/resources/hosted/controlled-vocabularies-and-skos/vocabs-iad.jpg)
...
* SKOS files can also be programmed, for example, using Python [rdflib](https://rdflib.readthedocs.io/) package - a package to work with RDF data

[SKOSMOS](http://skosmos.org/) is a vocabulary repository and browser which queries data via a SPARQL endpoint and provides a REST API to allow for linked data.

### Validation

Validation tools are very important to detect any inconsistencies in SKOS structure and syntax.

* [Skosify](https://github.com/NatLibFi/Skosify) - corrects errors and adds missing symmetric statements; it can be used as a command line tool or python library.

* [SKOS Testing tool](http://labs.sparna.fr/skos-testing-tool/) - provides a validation report on the quality of submitted SKOS file; based on qSKOS.
...
The [Austrian Centre for Digital Humanities and Cultural Heritage (ACDH-CH)](https://www.oeaw.ac.at/acdh/) provides a suite of services for collaborative creation, maintenance and sharing of vocabularies of any kind. Some services adapt existing open source tools to the needs of users and some are developed at the ACDH-CH.

ACDH-CH vocabs contains four major services covering different aspects of vocabulary usage:

1. [Vocabs repository](https://vocabs.acdh.oeaw.ac.at/en/) is a service based on the open source tool [SKOSMOS](https://skosmos.org/) to allow publication, reuse and retrieval of controlled vocabularies. It provides an API endpoint in order to integrate vocabulary terms in web applications.
...
3. [Vocabs SPARQL](https://vocabs-sparql.acdh.oeaw.ac.at/) is an interface for querying vocabularies triple store with SPARQL queries. It is developed on top of [Jena Fuseki](https://jena.apache.org/documentation/fuseki2/) triple store and uses a [YASGUI](https://triply.cc/docs/yasgui) interface to access the endpoint.
...
[^3]: [DariahTeach: Text encoding and the Text Encoding Initiative](https://teach.dariah.eu/course/view.php?id=23)

[^4]: [Backbone Thesaurus](https://www.backbonethesaurus.eu/)

[^5]: [Alistair Miles, Sean Bechhofer. SKOS Reference, W3C Recommendation 18 August 2009](https://www.w3.org/TR/skos-reference/)

[^6]: [IAD Thesaurus](https://vocabs.acdh.oeaw.ac.at/iad_thesaurus/en/)
